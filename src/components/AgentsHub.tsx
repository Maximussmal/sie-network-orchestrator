    ...
    <div className="h-full overflow-y-auto p-6 bg-background space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-5 bg-gradient-to-br from-primary/10 to-accent/10 border-0 shadow-sm">
          ...
          <div className="text-3xl font-bold text-foreground mb-1">112</div>
          <div className="text-sm text-muted-foreground">Total Connections</div>
          <div className="text-xs text-accent mt-2">+18% this month</div>
        </Card>
        ...
        <Card className="p-5 bg-gradient-to-br from-accent/10 to-primary/10 border-0 shadow-sm">
          ...
          <div className="text-sm text-muted-foreground">Engaged Network</div>
          <div className="text-xs text-primary mt-2">84% engagement rate</div>
        </Card>
        ...
        <Card className="p-5 bg-gradient-to-br from-primary/10 to-accent/10 border-0 shadow-sm">
          ...
          <div className="text-xs text-accent mt-2">Excellent status</div>
        </Card>
        ...
        <Card className="p-5 bg-gradient-to-br from-accent/10 to-primary/10 border-0 shadow-sm">
          ...
          <div className="text-xs text-primary mt-2">This month</div>
        </Card>
      </div>
